...
and it remains a topic for future research. \EZY{This seems like a very strong claim.}
...
the results obtained are (thus far) difficult to rely upon. \EZY{I think you can make this construction parallel: e.g., the open problems of supercompilation are vast, the results of supercompilation difficult to rely on}
...
with the latest wave of renewed interest starting 6-7 years ago? \EZY{Would be nice if you could briefly cite some evidence here}
